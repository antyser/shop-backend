...
def parse_html(html_content: str | None) -> str:
    ...
    try:
        ...
        for line in result:
            ...
            if any(pattern in line.lower() for pattern in ["var ", "function()", ".js", ".css", "google-analytics", "disqus", "{", "}"]):
                continue
...
def main():
    ...
    parser.add_argument("--max-concurrent", type=int, default=5, help="Maximum number of concurrent browser instances (default: 5)")
